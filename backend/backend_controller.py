...
class BackendController(QObject):
    ...
    def _get_guitar_split(self):
        return self._splitter.guitarSplit

    def _set_guitar_split(self, val):
        self._splitter.guitarSplit = val
        self._log(f"Guitar split: {val}")

    guitarSplit = Property(bool, _get_guitar_split, _set_guitar_split)
