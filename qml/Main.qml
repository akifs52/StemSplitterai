...
ApplicationWindow {
    ...
    property bool guitarSplitChecked: false
                    ...
                    Flickable {
                        ...
                        Column {
                            ...
                            Row { width: parent.width; spacing: 24
                                ...
                                Rectangle { width: (parent.width - 24) * 0.48; height: 380; radius: 24; color: Qt.rgba(1,1,1,0.03); border.color: Qt.rgba(1,1,1,0.08); border.width: 1
                                    Column { anchors.fill: parent; anchors.margins: 20; spacing: 18
                                        ...
                                        // --- Guitar split checkbox ---
                                        Item { width: parent.width; height: 22
                                            Rectangle {
                                                width: 18; height: 18; radius: 4
                                                anchors.verticalCenter: parent.verticalCenter
                                                border.color: guitarSplitMa.containsMouse ? "#00e388" : Qt.rgba(0.73,0.8,0.73,0.3)
                                                border.width: 1
                                                color: guitarSplitChecked ? Qt.rgba(0,0.89,0.53,0.15) : "transparent"
                                                Text {
                                                ...
                                                MouseArea {
                                                    ...
                                                    cursorShape: Qt.PointingHandCursor
                                                    onClicked: {
                                                        guitarSplitChecked = !guitarSplitChecked
                                                        backend.guitarSplit = guitarSplitChecked
                                                    }
                                                }
                                            }
                                            Text {
                                                ...
                                                anchors.verticalCenter: parent.verticalCenter
                                                text: "Split guitar into lead & rhythm"
                                                color: "#e2e2e2"
                                                font.family: "Inter"
                                                font.pixelSize: 12
                                            }
